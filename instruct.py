...
def write_subtitle(filename):
    ...
    """open the file and read it, then use re module to re-write it. then format the result"""
    ...
    """create a new file and filled with the "new_string" that re-write-formatted above."""
